...
from _style import C_BASE, C_OURS, C_WARN, DATA, apply_style, save  # noqa: E402
...
def main():
    ...
    ax.set_xscale("log")
    ax.set_xlabel(r"Packet loss probability $p$")
    ax.set_ylabel("Required bandwidth (B/s)")
    ax.set_title(r"Loss sweep (motion hazard; PISTIS landmark $p{=}0.5$)")
