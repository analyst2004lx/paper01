# -*- coding: utf-8 -*-
"""Method architecture M1--M7 (paper03 fig:architecture)."""
...
def main() -> None:
    ...
    ax.text(0.35, 3.72, "OFFLINE / PRE-DISPATCH", ha="left", va="bottom",
    ...
    ax.text(-0.08, y_on + 0.52, "ONLINE", ha="center", va="center",
