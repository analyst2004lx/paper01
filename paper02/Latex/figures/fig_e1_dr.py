...
def main():
    ...
    data = {
        ...
        u"TABOR-like": np.array([0.04, 0.67, 0.10, -0.01, 0.48, -0.01]),
        u"HSMM": np.array([-0.01, 0.31, 0.06, 0.02, 0.25, 0.05]),
        u"Label-only": np.array([0.48, 0.76, -0.01, 0.23, 0.00, 0.28]),
        u"Ours": np.array([0.55, 0.95, 0.18, 0.17, 0.87, 0.14]),
    }
